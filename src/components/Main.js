    ...
    return (
      ...
      >
        ...
        >
          ...
          <p>
            I recieved my Phd from{' '}
            <a href="https://www.epfl.ch/en/home/">
              {' '}
        ...
        <article
          ...
          style={{ display: 'none' }}
        >
          <h2 className="major">Research Interests</h2>
          <span className="image main">
            <img src={pic02} alt="" />
          </span>
          <p>
        ...
        <article
          ...
          style={{ display: 'none' }}
        >
          <h2 className="major">Professional Experience</h2>
          <span className="image main">
            <img src={pic02} alt="" />
          </span>
          <p>
        ...
        <article
          id="publication"
          className={`${this.props.article === 'publication' ? 'active' : ''} ${
            this.props.articleTimeout ? 'timeout' : ''
          }`}
          style={{ display: 'none' }}
        >
